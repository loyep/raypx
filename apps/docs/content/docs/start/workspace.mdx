...
Raypx is a pnpm monorepo orchestrated by Turborepo. It contains **3 applications** and **9 shared packages** that work together to provide a complete full-stack development platform.
...
| **@raypx/scripts** | Build & dev scripts | raypx-scripts CLI |
...
- **@raypx/api** depends on auth, database for protected procedures
...
bun run --filter @raypx/database push          # Push schema to database
