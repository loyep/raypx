import { authClient, signIn, signUp } from "@raypx/auth/client";
...
export function EmailSignUpForm({
  ...
  termsLinkClassName = "font-semibold text-primary underline decoration-primary/70 underline-offset-3 transition-colors hover:text-primary/90 hover:decoration-primary",
          ...
          {(field) => (
            ...
            >
              ...
              <FormControl>
                ...
                >
                  I agree to the{" "}
                  <Link className={termsLinkClassName} to="/terms">
                    Terms of Service
                  </Link>{" "}
                  and{" "}
                  <Link className={termsLinkClassName} to="/privacy">
                    Privacy Policy
                  </Link>
                </FormLabel>
