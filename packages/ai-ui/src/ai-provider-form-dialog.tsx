...
export function createEmptyAIProviderForm(showSetDefault = false): AIProviderFormValues {
  return {
    mode: "create",
    name: "",
    driver: "openai",
    ...
    modelsText: "",
    apiKey: "",
    ...(showSetDefault && { setDefault: false }),
  };
}

export const emptyAIProviderForm = createEmptyAIProviderForm();
export const emptyAIProviderFormWithSetDefault = createEmptyAIProviderForm(true);

function createProviderFormSchema(showSetDefault: boolean) {
  const base = z.object({
  ...
  if (showSetDefault) {
    return base.extend({ setDefault: z.boolean() });
  }
  return base;
}

export type AIProviderFormDialogProps = {
  description?: string;
...
export function AIProviderFormDialog({
  ...
  const form = useForm({
    ...
    validators: {
      onSubmit: createProviderFormSchema(showSetDefault),
    },
